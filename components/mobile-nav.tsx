      ...
      <div className="pointer-events-auto w-full max-w-3xl">
        ...
        >
          ...
          <div className="hidden md:flex items-center gap-7" style={{ fontFamily: "system-ui, -apple-system, sans-serif" }}>
            {NAV_LINKS.map(l => (
              <a
                key={l.label}
                href={l.href}
                className="text-[11px] text-black hover:text-black/70 transition-colors duration-200 tracking-wide"
              >
                {l.label}
              </a>
            ))}
          ...
          <div className="flex items-center gap-2">
            <a href="/contact" className="text-[11px] px-5 py-2.5 rounded-xl bg-black text-white font-semibold hover:bg-black/80 transition-all duration-200 tracking-wide hidden md:block" style={{ fontFamily: "system-ui, -apple-system, sans-serif" }}>
              BOOK A CALL
            </a>
          ...
          >
            {NAV_LINKS.map(l => (
              <a
                ...
                href={l.href}
                onClick={close}
                className="px-4 py-3 text-sm text-black hover:text-black/70 hover:bg-black/[0.03] rounded-xl transition-colors tracking-wide"
            ...
            <div className="mt-1 px-2 pb-1">
              <a href="/contact" className="block w-full text-center text-[11px] px-4 py-2.5 rounded-xl bg-black text-white font-semibold hover:bg-black/80 transition-all duration-200 tracking-wide" style={{ fontFamily: "system-ui, -apple-system, sans-serif" }}>
                BOOK A CALL
              </a>
            </div>
          </div>
